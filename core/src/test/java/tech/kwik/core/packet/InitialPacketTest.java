...
class InitialPacketTest {
    ...
    void parseValidInitial() throws Exception {
        ...
        ConnectionSecrets connectionSecrets = new ConnectionSecrets(VersionHolder.with(Version.IETF_draft_29), Role.Client, logger);
    ...
    void parseInitialWithTwoByteTokenLength() throws Exception {
        ...
        ConnectionSecrets connectionSecrets = new ConnectionSecrets(VersionHolder.withDefault(), Role.Client, logger);
    ...
    void decrypt() throws Exception {
        ...
        ConnectionSecrets connectionSecrets = new ConnectionSecrets(VersionHolder.with(IETF_draft_29), Role.Client, mock(Logger.class));
    ...
    void generateValidInitial() throws MissingKeysException {
        ...
        ConnectionSecrets connectionSecrets = new ConnectionSecrets(VersionHolder.with(Version.IETF_draft_29), Role.Server, logger);
        connectionSecrets.computeInitialKeys(ByteUtils.hexToBytes("dcd29c5480f39a24"));
